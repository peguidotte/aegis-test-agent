...
ensure_topic "aegis-test.test-generation.requested"
ensure_topic "aegis-test.test-generation.planning.started"
ensure_topic "aegis-test.test-generation.planning.completed"
ensure_topic "aegis-test.test-generation.planning.failed"

echo "Creating subscriptions (idempotent)..."
ensure_subscription "test-planner.aegis-test.test-generation.requested" "aegis-test.test-generation.requested"
ensure_subscription "orchestrator.aegis-test.test-generation.planning.started" "aegis-test.test-generation.planning.started"
ensure_subscription "orchestrator.aegis-test.test-generation.planning.completed" "aegis-test.test-generation.planning.completed"
ensure_subscription "orchestrator.aegis-test.test-generation.planning.failed" "aegis-test.test-generation.planning.failed"
